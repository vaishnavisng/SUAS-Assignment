...
export default function AskStep({ query, setQuery, onProceed }) {
  ...
  return (
    <div className="animate-fade-in ask-hero">
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '4px 14px', borderRadius: '999px', background: 'var(--accent-glow)', color: 'var(--font-accent)', fontSize: '0.8rem', fontWeight: 600, marginBottom: '16px', border: '1px solid var(--border-accent)' }}>
